...
function gmw_pt_form_get_post_types_dropdown( $gmw, $title, $class, $all_label ) {
    ...
    if ( isset( $gmw['search_form']['post_types_type'] ) && $gmw['search_form']['post_types_type'] == 'checkbox' ) {
    	...
    	$output .= '<select name="'.$gmw['url_px'].'post" id="gmw-posts-dropdown-' . $gmw['ID'] . '" style="display:none;" class="gmw-posts-dropdown gmw-posts-dropdown-'.$gmw['ID'].' '.$class.'">';
    	...
    	$output .= '</select>';
			...
			$output .= 'Sort results based on distance to: <select name="'.$gmw['url_px'].'post_type" id="gmw-type-dropdown-' . $gmw['ID'] . '" class="gmw-type-dropdown gmw-type-dropdown-'.$gmw['ID'].' '.$class.'">';
			if(!isset( $_GET[$gmw['url_px'].'post_type'] )){
				$output .= '<option value="HTL" selected="selected">Hotel</option>';
				$output .= '<option value="MYL">My Location</option>';
			}
			elseif(isset( $_GET[$gmw['url_px'].'post_type'] ) && $_GET[$gmw['url_px'].'post_type'] == "HTL" ){
    		$output .= '<option value="HTL" selected="selected">Hotel</option>';
				$output .= '<option value="MYL">My Location</option>';
			}
			else{
				$output .= '<option value="HTL">Hotel</option>';
				$output .= '<option value="MYL" selected="selected">My Location</option>';
			}
    	$output .= '</select>';
	}
