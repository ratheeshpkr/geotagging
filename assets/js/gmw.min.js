...
jQuery(document).ready(function(a){function c(a){k(a.results)}function h(b){2==b.type?alert("Geocoder failed due to: "+b.message):alert(b.message);0!=g&&a("#gmw-locator-btn-loader-"+g).show("fast",function(){a(".locator-submitted").show("fast").removeClass("locator-submitted");a(".gmw-address").removeAttr("disabled");a(".gmw-submit").removeAttr("disabled")})}function k(l){var m="",f="",c="",h="",k="",q="",d=l[0].address_components,n=l[0].geometry.location.lat(),p=l[0].geometry.location.lng();
...
g).show("fast",function(){locatorButton.show("fast")});b.find(".gmw-submit").click()},1500):a("#gmw-locator-btn-loader-"+g).show("fast",function(){a(".locator-submitted").show("fast").removeClass("locator-submitted")}))}a(".gmw-map-loader").fadeOut(1500);jQuery().chosen&&a(".gmw-chosen").chosen();navigator.geolocation||a(".gmw-locator-btn-wrapper").hide();a(".gmw-address").focus(function(){a(this).hasClass("gmw-no-address-error")&&a(this).removeClass("gmw-no-address-error")});
...
console.log("We could not find the address you entered for the following reason: ");})}else return!0});var e=!1,b=!1,g=!1;1==gmwSettings.general_settings.auto_locate&&1!=gmwGetCookie("gmw_autolocate")&&(gmwSetCookie("gmw_autolocate",1,1),e=!0,GmwAutoLocator(c,h));a(".gmw-locate-btn").click(function(){g=a(this).closest("form").find(".gmw-form-id").val();locatorButton=a(this);b=a(this).closest("form");b.find(".gmw-lat").val("");b.find(".gmw-lng").val("");a(this).toggleClass("locator-submitted");locatorButton.show("fast",
function(){a("#gmw-locator-btn-loader-"+g).show("fast",function(){a(".gmw-address").attr("disabled","disabled");a(".gmw-submit").attr("disabled","disabled");
GmwAutoLocator(c,h)})})})
});
