...
class GEO_my_WP {
	...
	public function includes() {
		...
		$gmw_options['general_settings']['address_filter'] = gmw_get_option( 'general_settings', 'address_filter', $gmw_forms[1]['page_load_results']['address_filter'] );
	...
	public function register_scripts() {
		...
		if ( !is_admin() ) {
			...
			//register gmw script
			wp_register_script( 'gmw-js', GMW_URL.'/assets/js/gmw.js', array( 'jquery' ), GMW_VERSION, true );
