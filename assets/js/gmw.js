...
function GmwAddressLocator(address, gmwLocatorSuccess, gmwLocatorFailed){
...
jQuery(document).ready(function($) {
  ...
  $(".gmw-type-dropdown").change(function(){
    if($(this).val() == "MYL"){
      GmwAutoLocator(gmwLocatorSuccess,gmwLocatorFailed);
      //$(".gmw-full-address").val(gmwGetCookie("gmw_address"));
    }
    else if($(this).val() == "HTL"){
      var address = gmwSettings.general_settings.address_filter;
      GmwAddressLocator(address,gmwLocatorSuccess,gmwLocatorFailed);
      //$(".gmw-full-address").val(gmwGetCookie("gmw_address"));
    }
  });
    ...
    $('.gmw-form').submit(function(e) {
        ...
        if($('.gmw-type-dropdown').val() == "HTL"){
          address = gmwSettings.general_settings.address_filter;
          GmwAddressLocator(address,gmwLocatorSuccess,gmwLocatorFailed);
          $(".gmw-full-address").val(address);
          $(".gmw-lat").val('');
          $(".gmw-lng").val('');
        }
        else{
    ...
    if ( gmwSettings.general_settings.auto_locate == 1) {
    ...
    function getAddressFields(results) {
        ...
        $(".gmw-full-address").val(results[0].formatted_address);
